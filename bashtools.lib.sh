...
BSHT_FLAG_NO_ROOT=${BSHT_FLAG_NO_ROOT:-0}
BSHT_FLAG_LOG_FILE_ENABLED=${BSHT_FLAG_LOG_FILE_ENABLED:-0}
BSHT_FLAG_SUPPRESS_ROOT_WARN=${BSHT_FLAG_SUPPRESS_ROOT_WARN:-0}
BSHT_PATH_LOG_FILE=${BSHT_PATH_LOG_FILE:-${BSHT_PATH_ROOT_DIR}/bsht_output.log}
BSHT_FLAG_LOG_SIMPLE=${BSHT_FLAG_LOG_SIMPLE:-0}
